    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex">
                    <button class="btn btn-info mr-2" id="refreshFaq">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add New FAQ Management</h5>
...
$(document).ready(function() {
    ...
    const faqTable = $('#faqTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: 'admin_ajax/get_faq.php',
            type: 'POST'
        },
        order: [[3, 'desc']],
        columns: [
