-- Enhanced Email Template: Wallet Verified
-- Template Key: wallet_verified
-- Category: wallet
-- Description: Enhanced email notification with formal greeting and detailed guidance when wallet is verified
-- This is an UPDATE statement to replace the existing template with enhanced content

UPDATE email_templates SET
    subject = 'Wallet verifiziert - {{cryptocurrency}} - {{brand_name}}',
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 40px 30px;">
            ...
            <!-- Heading -->
            <h2 style="color: #4CAF50; margin-top: 0; text-align: center; font-size: 24px;">
            ...
            <!-- Message -->
            <p style="color: #666; line-height: 1.8; font-size: 15px;">
                Wir freuen uns, Ihnen mitteilen zu können, dass Ihre <strong>{{cryptocurrency}}</strong> Wallet 
            ...
            <div style="background-color: #f0fdf4; padding: 25px; border-radius: 8px; 
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr style="background-color: #dcfce7;">
                        ...
                        <td style="padding: 10px 0; color: #166534; font-weight: bold;">
                            {{verification_date}}
                        </td>
                    </tr>
                </table>
            ...
            <div style="margin: 30px 0;">
                ...
                <p style="color: #666; line-height: 1.8; font-size: 15px;">
                    Ihre Wallet ist nun vollständig verifiziert und aktiv. Sie können ab sofort:
                </p>
                <ul style="color: #666; line-height: 1.8; font-size: 15px; padding-left: 20px;">
                    <li>Einzahlungen auf diese Wallet vornehmen</li>
                    <li>Auszahlungen von Ihrem Guthaben anfordern</li>
                    <li>Transaktionen in Echtzeit verfolgen</li>
                    <li>Ihre Wallet für Rückerstattungen verwenden</li>
                </ul>
            </div>
            ...
            <div style="background-color: #dbeafe; padding: 20px; border-radius: 8px; 
                ...
                <ol style="color: #1e3a8a; line-height: 1.8; font-size: 15px; margin: 10px 0; padding-left: 20px;">
                    ...
                    <li>Navigieren Sie zu "Zahlungsmethoden"</li>
                    <li>Ihre verifizierte Wallet ist nun aktiv und einsatzbereit</li>
                    <li>Fügen Sie bei Bedarf weitere Wallets hinzu</li>
                </ol>
            </div>
            ...
            <div style="text-align: center; margin: 35px 0;">
                <a href="{{dashboard_url}}/payment-methods.php" 
                   style="display: inline-block; padding: 15px 40px; 
                          ...
                          font-weight: bold; font-size: 16px; box-shadow: 0 4px 6px rgba(76, 175, 80, 0.3);">
                    Zu meinen Wallets →
                </a>
            </div>
            ...
            <div style="background-color: #e7f3ff; padding: 20px; border-radius: 8px; 
                ...
                <p style="color: #055160; line-height: 1.8; font-size: 14px; margin: 0;">
                    <strong>💡 Wichtig:</strong> Bewahren Sie Ihre Wallet-Zugangsdaten sicher auf. 
                    Teilen Sie niemals Ihre privaten Schlüssel oder Recovery-Phrasen mit anderen Personen, 
                    auch nicht mit unserem Support-Team.
                </p>
            </div>
            
            <!-- Additional Info -->
            <p style="color: #666; line-height: 1.8; font-size: 14px; margin-top: 30px;">
                Bei Fragen zu Ihrer verifizierten Wallet oder zu Transaktionen stehen wir Ihnen gerne zur Verfügung. 
